...
import {submitProduct} from '../../api/internal'
import { useSelector } from "react-redux";
import style from "./buyProduct.module.css";
import buyProductRegisterSchema from '../../schemas/BuyProductSchema'


export default function BuyPorduct(){
    ...
    const handleSubmit = async () => {
        ...
        const data = {
          ...
          productId: productId, // Change values.email to values.productId
        };
